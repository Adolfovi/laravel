export let renderModalDelete = () => {
    ...
    let modalDelete = document.querySelector('.deletenotificationcontainer');
    let deleteConfirm = document.querySelector('.yes');
    let deleteCancel = document.querySelector('.no');
