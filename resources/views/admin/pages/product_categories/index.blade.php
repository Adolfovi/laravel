                ...
                <div class="desktop-two-columns mobile-two-columns">
                    <div class="column">
                        <div class="elements-configuration-element-subelement">
                            <h4>Id: </h4><span class="title">{{$product_category->id}}</span>
                        </div>
                        <div class="elements-configuration-element-subelement">
                            <h4>Nombre: </h4><span class="title">{{$product_category->name}}</span>
                        </div>
                        <div class="elements-configuration-element-subelement">
                            <h4>Fecha: </h4><span class="title">{{$product_category->created_at}}</span>
                        </div>
                    </div>
                    <div class="column" style="display: flex;align-items: center;justify-content: flex-end;">
                        <div class="pencil" data-url="{{route('product_categories_edit', ['product_category' => $product_category->id])}}">
                        ...
                        <div class="thrash" data-url="{{route('product_categories_destroy', ['product_category' => $product_category->id])}}">
                            <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                                <path fill="currentColor"
...
@section('form')
    @if($product_category)
        <form action="{{route("product_categories_store")}}" method="post" class="admin-form">
            ...
            <div class="administration-editor-menu-nav">
                <div class="desktop-two-columns mobile-two-columns">
                    ...
                    <div class="icons-header-form-container">
                        ...
                        <div class="icons-header-form-icon-delete" data-url="{{route('product_categories_create')}}">
                            <svg style="width:28px;height:28px" viewBox="0 0 24 24">
                    ...
                    <div class="column">
                        <div class="form-name">
                            ...
                            <div class="form-name-result">
                                <input name="name" value="{{isset($product_category->name) ? $product_category->name : ''}}">
                            </div>
                        </div>
                    </div>
                </div>
