                ...
                <div class="desktop-two-columns mobile-two-columns">
                    <div class="column">
                        <div class="elements-configuration-element-subelement">
                            <h4>Id: </h4><span class="title">{{$cart_element->id}}</span>
                        </div>
                        <div class="elements-configuration-element-subelement">
                            <h4>Nombre: </h4><span class="title">{{$cart_element->price->product->title}}</span>
                        </div>
                        <div class="elements-configuration-element-subelement">
                            <h4>Precio base: </h4><span class="title">{{$cart_element->price->base_price}}€</span>
                        </div>
                    </div>
                    <div class="column" style="display: flex;align-items: center;justify-content: flex-end;">
                        <div class="pencil" data-url="{{route('carts_edit', ['cart' => $cart_element->id])}}">
                        ...
                        <div class="thrash" data-url="{{route('carts_destroy', ['cart' => $cart_element->id])}}">
                            <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                                <path fill="currentColor"
...
@section('form')
    @if($cart)
        <form action="{{route("carts_store")}}" method="post" class="admin-form">
                    ...
                    <div class="column">
                        <div class="form-name">
                            ...
                            <div class="form-name-result">
                                <input name="name" value="{{isset($cart->price->product->title) ? $cart->price->product->title : ''}}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="column">
                            <div class="form-content-data-name">
                                ...
                                <div class="form-content-data-name-result">
                                    <input type="text" name="surname" value="{{isset($cart->price->base_price) ? $cart->price->base_price : ''}}">
                                </div>
                            </div>
                        </div>
                    </div>
